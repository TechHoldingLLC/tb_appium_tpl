   ...
   @BeforeSuite
    ...
    public static void launchApp(String platformName){
        ...
        if(platformName.equalsIgnoreCase("iOS")){
            ...
            dc.setCapability("app", "/Users/karishmabarot/Documents/Projects/TheraBody/Builds/therabody-export-840.ipa");
            ...
            dc.setCapability("appPackage", "com.g4app.dev");
            dc.setCapability("appActivity", "com.g4app.ui.MainActivity");
            dc.setCapability("noReset",false);
            dc.setCapability(MobileCapabilityType.AUTOMATION_NAME, AutomationName.ANDROID_UIAUTOMATOR2);
            dc.setCapability("app", "/Users/karishmabarot/Documents/Projects/TheraBody/Builds/app-dev-release (3).apk");
            dc.setCapability("autoGrantPermissions",true);
  ...
  /*  @AfterMethod
    public void addResultToTestRail(ITestResult result){
       if(result.getStatus() == ITestResult.SUCCESS){
           TestRailManager.addResultForTestCase(testCaseID ,TestRailManager.TEST_RAIL_PASS_STATUS,"Test passed!" );
       } else if (result.getStatus() == ITestResult.FAILURE) {
           TestRailManager.addResultForTestCase(testCaseID, TestRailManager.TEST_RAIL_FAIL_STATUS,"Test failed: "+result.getName());
