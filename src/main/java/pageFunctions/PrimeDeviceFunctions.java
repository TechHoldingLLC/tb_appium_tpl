...
public class PrimeDeviceFunctions extends Setup {
    ...
    public void forgetDevice(){
        ...
        try {
            ...
            System.out.println("Checking visibility of device dropdown");
            waitForElementVisibility(deviceObjects.deviceDropDown);
            Assert.assertTrue(deviceObjects.deviceDropDown.isDisplayed());
        }catch (TimeoutException e){
            System.out.println("Checking visibility of device dropdown");
            waitForElementVisibility(deviceObjects.deviceDropDown);
            Assert.assertTrue(deviceObjects.deviceDropDown.isDisplayed());
