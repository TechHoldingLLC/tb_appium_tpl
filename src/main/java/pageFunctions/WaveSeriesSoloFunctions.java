...
public class WaveSeriesSoloFunctions extends Setup {
    ...
    public void routineStepStretching() throws InterruptedException {
        ...
        waveSeriesSoloObject.closeBTN.click();
        waitForElementClickAbility(waveSeriesSoloObject.endRoutine);
        System.out.println("Routine overview screen appeared!!");
        log.info("Routine overview screen appeared!!");
    ...
    public void removeStretchingStep() throws InterruptedException {
        ...
        utilityMethods.toggleSwitchIfOff(waveSeriesSoloObject.stretchingToggle);
        ...
        Point toggle = getCenterCoordinates(waveSeriesSoloObject.preferencesBTN);
        action_clickOnPosition(toggle.getX(), toggle.getY());

        utilityMethods.getToggleSwitchStatus(waveSeriesSoloObject.stretchingToggle);
        utilityMethods.toggleSwitchIfOn(waveSeriesSoloObject.stretchingToggle);
    ...
    public void addBreak() throws InterruptedException {
     ...
     /*   try {*/
        ...
        try {
            ...
            if(platform_param.equalsIgnoreCase("iOS")){
                action_clickOnPosition(331,238);
            }
        }*/
    ...
    public void saveRoutine() {
       ...
       try {
           ...
           waitForElementVisibility(waveSeriesSoloObject.saveBTN);
           Assert.assertTrue(waveRollerObjects.getRoutineName(routinename).isDisplayed());
       }
